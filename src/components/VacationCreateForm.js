...
const VacationCreateForm = ({ token, setVacation}) => {
    ...
    return (<form className="ui form" onSubmit={async (event) => {
        ...
        const {error, vacation} = await createVacation(token, description, location);
        ...
        <div className="field">
            ...
            <input name="description" type="text" placeholder="A description of Vacation Spot" required autoComplete="off"
                value={description}
        ...
        <div className="field">
            ...
            <input name="location" type="text" placeholder="Where is this Vacation?" autoComplete="off"
                value={location}
